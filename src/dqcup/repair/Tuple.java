...
public class Tuple {
	...
	public String toString(String format){
		...
		return cells.get("RUID") + ":" + cells.get("CUID") + ":" + cells.get("SSN") 
				+ ":" + cells.get("FNAME") + ":" + cells.get("MINIT") + ":" + cells.get("LNAME") + ":" + cells.get("STNUM")
				+ ":" + cells.get("STADD") + ":" + cells.get("APMT") + ":" + cells.get("CITY") 
				+ ":" + cells.get("STATE") + ":" + cells.get("ZIP");
	}
