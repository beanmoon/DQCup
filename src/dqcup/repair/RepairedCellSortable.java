...
public class RepairedCellSortable implements Comparable<RepairedCellSortable>{
	private int rowId;
	private String columnId;
	private String value;
	
	public RepairedCellSortable(int rowId, String columnId, String value){
		this.rowId = rowId;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RepairedCellSortable other = (RepairedCellSortable) obj;
		if (columnId == null) {
	...
	@Override
	public int compareTo(RepairedCellSortable o) {
